...
- [Simple Gem Layout](#simple-gem-layout)
- [Complex Gem Layout (PgHero pattern)](#complex-gem-layout-pghero-pattern)
- [Method Decomposition Pattern](#method-decomposition-pattern)
- [Version File Pattern](#version-file-pattern)
- [Require Order in Entry Point](#require-order-in-entry-point)
