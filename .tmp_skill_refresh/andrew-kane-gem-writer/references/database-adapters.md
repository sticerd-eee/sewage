...
- [MariaDB Adapter (MySQL variant)](#mariadb-adapter-mysql-variant)
- [Adapter Detection Pattern](#adapter-detection-pattern)
- [Multi-Database Support (PgHero pattern)](#multi-database-support-pghero-pattern)
- [Connection Switching](#connection-switching)
- [SQL Dialect Handling](#sql-dialect-handling)
