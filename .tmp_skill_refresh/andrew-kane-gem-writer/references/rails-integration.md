...
- [ActiveSupport.on_load Hooks](#activesupporton_load-hooks)
- [Prepend for Behavior Modification](#prepend-for-behavior-modification)
- [Railtie Pattern](#railtie-pattern)
- [Engine Pattern (Mountable Gems)](#engine-pattern-mountable-gems)
- [Routes for Engines](#routes-for-engines)
- [YAML Configuration with ERB](#yaml-configuration-with-erb)
- [Generator Pattern](#generator-pattern)
- [Conditional Feature Detection](#conditional-feature-detection)
