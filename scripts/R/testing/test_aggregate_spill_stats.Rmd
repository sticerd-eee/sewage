...
file_path_new_mo <- here::here("data", "processed", "agg_spill_stats", "agg_spill_stats_mo.parquet")
file_path_new_qtr <- here::here("data", "processed", "agg_spill_stats", "agg_spill_stats_qtr.parquet")
...
data_qtr_og <- open_dataset(file_path_qtr_og) %>%
  filter(radius == 2000) %>%
  collect()
date_new_mo <- import(file_path_new_mo, trust = TRUE)
data_new_qtr <- import(file_path_new_qtr, trust = TRUE)
