...
run_all_models <- function(RIVER_DIST) {
  ...
  notes_count <- make_notes(paste0("Spill exposure is the average number of spill events per day (12/24 count) recorded at the nearest overflow within ", RIVER_DIST, "m along the river from January 2021 to the transaction date."))
  notes_hrs   <- make_notes(paste0("Spill exposure is the average total spill hours per day recorded at the nearest overflow within ", RIVER_DIST, "m along the river from January 2021 to the transaction date."))
