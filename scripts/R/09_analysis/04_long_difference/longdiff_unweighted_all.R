# ==============================================================================
# Long Difference Regression Analysis
# ==============================================================================
#
...
#
# Outputs:
#   - output/tables/longdiff_unweighted_all.tex
#
# ==============================================================================
...
cat(
  "  Grid cells with valid spill exposure:", 
  sum(!is.na(dat_sales_diff$delta_spill_count)), "\n")
...
cat(
  "  Grid cells with valid spill exposure:", 
  sum(!is.na(dat_rental_diff$delta_spill_count)), "\n")
...
cat("\n")
cat("=" |> rep(60) |> paste(collapse = ""), "\n")
cat("Summary Statistics: Rentals\n")
cat("=" |> rep(60) |> paste(collapse = ""), "\n")
...
cat("\n")
cat("=" |> rep(60) |> paste(collapse = ""), "\n")
cat("Estimating long difference models...\n")
cat("=" |> rep(60) |> paste(collapse = ""), "\n")
