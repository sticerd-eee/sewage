# ==============================================================================
# Long Difference Regression Analysis (Weighted)
# ==============================================================================
#
...
#
#              This version weights regressions by total transactions in each
#              grid cell to reduce noise from cells with few observations.
#
...
#
# Outputs:
#   - output/tables/longdiff_weighted_all.tex
#
# ==============================================================================
...
dat_sales_diff <- dat_sales_start |>
  ...
  dplyr::filter(
    ...
    !is.na(delta_spill_hrs),
    !is.na(total_transactions)
  )

cat("  Grid cells with valid prices in both years:", nrow(dat_sales_diff), "\n")
...
cat("  Grid cells with valid prices in both years:", nrow(dat_rental_diff), "\n")
...
cat("Summary Statistics: Sales (Weighted)\n")
cat("=" |> rep(60) |> paste(collapse = ""), "\n")
...
cat("\n")
cat("=" |> rep(60) |> paste(collapse = ""), "\n")
cat("Summary Statistics: Rentals (Weighted)\n")
cat("=" |> rep(60) |> paste(collapse = ""), "\n")
...
cat("\n")
cat("=" |> rep(60) |> paste(collapse = ""), "\n")
cat("Estimating weighted long difference models...\n")
cat("=" |> rep(60) |> paste(collapse = ""), "\n")
...
table_latex <- modelsummary::modelsummary(
  ...
  gof_map = gof_map,
  notes = " ",
  title = "Long Difference: Effect of Changes in Sewage Spills on Property Values (Weighted)"
)
...
table_latex <- sub(
  "caption=\\{([^}]*)\\},",
  "caption={\\1},\nlabel={tbl:longdiff-weighted-all},",
  table_latex
)
...
# Write to file
output_path <- file.path(output_dir, "longdiff_weighted_all.tex")
