...
#
# Outputs:
#   - output/tables/did_google_trends_prior.tex - LaTeX regression table
#
# ==============================================================================
...
model_sale_2 <- fixest::feols(
  log_price ~ spill_count_daily_avg + spill_count_daily_avg:post | lsoa + qtr_id,
  data = dat,
  vcov = conley(cutoff = CONLEY_CUTOFF)
)
...
# Write to file
output_path <- file.path(output_dir, "did_google_trends_prior.tex")
