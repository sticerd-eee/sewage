# ==============================================================================
# Intensive-Margin Cumulative Articles by Salience Group
# ==============================================================================
#
...
#
# Outputs:
#   - output/tables/did_articles_prior_salience_groups.tex
#   - output/regs/did_articles_prior_salience_groups.rds
#   - output/logs/did_articles_prior_salience_groups_{results,cell_counts}.csv
#
...
CONFIG <- list(
  coast_rule_m = 2000L,
  output_prefix = "did_articles_prior_salience_groups",
  title = "Intensive-Margin Cumulative Articles by Salience Group",
...
export_table <- function(result) {
  ...
  coefficient_map[paste0("spill_count_weekly_avg:", CONFIG$attention)] <- "{Spills per week (avg.) \\\\ $\\times$ $\\log (\\text{Articles})$}"
  notes <- paste0(
