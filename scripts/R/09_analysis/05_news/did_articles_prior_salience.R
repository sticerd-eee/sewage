# ==============================================================================
# Intensive-Margin Public Attention by Local Salience (Articles)
...
# Outputs: did_articles_prior_salience_{coast_bathing,intensity}.tex,
...
main <- function(reproduce_only = FALSE) {
  run_salience_intensive("articles", reproduce_only)
}
