...
#
# Outputs:
#   - output/tables/es_trends_prior.tex - LaTeX regression table
#   - output/figures/es_trends_prior_sales.pdf - Sales plot
#   - output/figures/es_trends_prior_rentals.pdf - Rentals plot
#
# ==============================================================================
...
ggsave(
  filename = file.path(figure_dir, "es_trends_prior_sales.pdf"),
  plot = sales_plot,
  width = PLOT_WIDTH,
  height = PLOT_HEIGHT,
  dpi = PLOT_DPI,
...
ggsave(
  filename = file.path(figure_dir, "es_trends_prior_rentals.pdf"),
  plot = rentals_plot,
  width = PLOT_WIDTH,
  height = PLOT_HEIGHT,
  dpi = PLOT_DPI,
