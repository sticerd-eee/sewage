# ==============================================================================
# Extensive-Margin Post August 2022 by Salience Group
# ==============================================================================
#
...
#
# Outputs:
#   - output/tables/did_trends_prior_extensive_salience_groups.tex
#   - output/regs/did_trends_prior_extensive_salience_groups.rds
#   - output/logs/did_trends_prior_extensive_salience_groups_{results,cell_counts}.csv
#
...
CONFIG <- list(
  coast_rule_m = 2000L,
  output_prefix = "did_trends_prior_extensive_salience_groups",
  title = "Extensive-Margin Post August 2022 by Salience Group",
  attention = "post",
  post_month_id = 20L,
  comparison = list(
...
export_table <- function(result) {
  ...
  coefficient_map[paste0("near_bin:", CONFIG$attention)] <- "{Near bin \\\\ $\\times$ Post}"
  notes <- paste0(
