...
- [ ] **Trends full-panel table** (`did_trends_full.tex`, currently unused by deck or paper) — still blocked: `05_news/did_trends_full.R` reads the stale `data/processed/general_panel/` (last built 2025-09). Migrate to the study-period cross-sections or rebuild the panels if the table is ever needed.
